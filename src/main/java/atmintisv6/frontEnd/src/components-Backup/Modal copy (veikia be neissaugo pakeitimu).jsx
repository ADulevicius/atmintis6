...
export const Modal = (props) => {
  ...
  const handleChange = (e) => {
    ...
    setFormState3((prevFormState) => ({
      ...
      occupation: e.target.name === 'occupation' ? e.target.value : formState3.companyName,
      
    }));
    console.log("HANDLECHANGE: formState3:", formState3);
  };

  const handleSubmit = (e) => {
    e.preventDefault();
    if(!validateForm()) return;
    props.onSubmit(formState3);
    props.closeModal();
  };
        ...
        <div className='model'>
            <form>
                ...
                <div className='form-group'>
                    ...
                    <textarea name="occupation" value={formState3.occupation} onChange={handleChange}/>
                </div>
                {/* <div className='form-group'>
